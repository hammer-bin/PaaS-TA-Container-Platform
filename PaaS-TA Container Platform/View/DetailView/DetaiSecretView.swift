...
struct DetailSecretView: View {
    ...
    var body: some View {
        ...
        if let secret = k8sVM.currentSecret, k8sVM.showDetail {
                    ...
                    VStack{
                        ...
                        VStack{
                            ...
                            VStack(alignment: .leading, spacing: 10){
                                Item(title: "Name", value: secret.name, width: 90)
                                Item(title: "Namespace", value: secret.namespace, width: 90)
                        ...
                        VStack{
                            ...
                            VStack(alignment: .leading, spacing: 10){
                                ...
                                Item(title: "Type", value: type, width: 90)
                            }
                            .padding(.vertical)
                            .padding(.horizontal, 25)
            ...
            .onAppear(perform: {
                k8sVM.secretInfo(namespace: secret.namespace, resourceName: secret.name)
            })
            .onReceive(k8sVM.$secretInfoData, perform: { value in
